...
data = pd.read_csv(os.path.join(root_dataset_folder, 'u.data'), sep='\t', names=r_cols,
encoding='latin-1')
ratings = pd.read_csv(os.path.join(root_dataset_folder, 'ua.base'), sep='\t', names=r_cols,
encoding='latin-1')
...
movies = pd.read_csv(os.path.join(root_dataset_folder, 'u.item'), sep='|', names=i_cols,
 encoding='latin-1')
